...
public class DomainRelationshipResource {
    ...
    public ResponseEntity<DomainRelationshipDTO> createDomainRelationship(@RequestBody DomainRelationshipDTO domainRelationshipDTO) throws URISyntaxException {
        ...
        domainRelationshipDTO.setId(UUID.randomUUID());
    ...
    public ResponseEntity<DomainRelationshipDTO> getDomainRelationship(@PathVariable UUID id) {
    ...
    public ResponseEntity<Void> deleteDomainRelationship(@PathVariable UUID id) {
